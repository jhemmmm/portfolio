      ...
      <main class="min-h-screen pt-28 pb-20 px-4 sm:px-6 lg:px-8">
         <div class="max-w-3xl mx-auto">
            ...
            <article v-else>
               ...
               <div class="prose prose-gray dark:prose-invert max-w-none prose-headings:font-bold prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4 prose-p:leading-relaxed prose-a:text-accent-600 dark:prose-a:text-accent-400 prose-a:no-underline hover:prose-a:underline prose-code:font-mono prose-code:text-sm prose-code:rounded prose-code:px-1.5 prose-code:py-0.5 prose-code:text-accent-700 prose-code:bg-accent-50 prose-code:border prose-code:border-accent-200 dark:prose-code:text-accent-400 dark:prose-code:bg-surface-card dark:prose-code:border-surface-border prose-pre:rounded-xl prose-pre:shadow-md prose-pre:overflow-x-auto prose-pre:bg-gray-100 prose-pre:border prose-pre:border-gray-200 dark:prose-pre:bg-[#0d0d0d] dark:prose-pre:border-surface-border [&_pre_code]:bg-transparent [&_pre_code]:border-0 [&_pre_code]:p-0 [&_pre_code]:text-gray-800 dark:[&_pre_code]:text-gray-200" v-html="post.content" />
